...
class DaySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('titles')->insert([
            [
                'name' => 'head_title',
                'value' => 'Кибербезопасный новый год'
            ],
            [
                'name' => 'head_moto',
                'value' => '31 шаг на пути к вашей цифровой безопасности'
            ],
            [
                'name' => 'head_description',
                'value' => 'Конец года – отличная возможность подвести итоги, сделать выводы и перейти на новый уровень. Шаг за шагом, выполняя простые советы и рекомендации экспертов компании «Киберпротект», вы сможете обезопасить себя и своих близких в цифровой среде.'
            ],
            [
                'name' => 'head_name',
                'value' => 'Новогодний Календарь'
            ],
